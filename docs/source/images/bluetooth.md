...
![Windows Bluetooth Setup - Step 1](images/Win-BT-Step1.png)


Click on the icon, and select the 'Add a Bluetooth Device' menu option.

![Windows Bluetooth Setup - Step 1](images/Win-BT-Step2.png)

Click on the 'Add Bluetooth or other device' selection.

![Windows Bluetooth Setup - Step 1](images/Win-BT-Step3.png)

Click on the 'Bluetooth - Mice, keyboards, pens, or audio and other kinds of Bluetooth devices' option.

![Windows Bluetooth Setup - Step 1](images/Win-BT-Step4.png)
...
![Windows Bluetooth Setup - Step 1](images/Win-BT-Step5.png)
...
![Windows Bluetooth Setup - Step 1](images/Win-BT-Step6.png)

Based on my experiences, you will want to select the higher port number.  

![Windows Bluetooth Setup - Step 1](images/Win-BT-Step7.png)

As an example, I am able to connect using a speed of 115200 using Putty. 

![Windows Bluetooth Setup - Step 1](images/Win-BT-Step8.png)
